...
natruim = form.getvalue('data1')
sugar = form.getvalue('data2')
fat = form.getvalue('data3')
protein = form.getvalue('data4')
...
if 'natruim' in form and 'sugar' in form and 'fat' in form and 'protein' in form:
    ...
    calorie, brand, name, hbg_list  = model_predict(list)
    output = calorie
else:
    output = 'No Data'
